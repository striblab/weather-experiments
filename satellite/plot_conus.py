...
if os.path.isfile(outfile) == False:
	...
	# Prepare the Clean IR band by converting brightness temperatures to greyscale values. Honestly I
	# have no idea what this is doing. I just stole it from here: https://github.com/occ-data/goes16-play
	# Ultimately it is used to create a nighttime mask so night clouds appear black and white.
	...
	# Hard-coded bounds from the geostationary projection
	...
	# Absurdly all of this is required to create a geotiff. 3 is the number of bands being output
